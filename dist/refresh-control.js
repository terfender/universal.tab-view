...
import Animated, { useAnimatedStyle, useAnimatedReaction, useSharedValue, withRepeat, withTiming, cancelAnimation, Easing, } from "react-native-reanimated";
import { RefreshTypeEnum, } from "@showtime-xyz/universal.collapsible-tab-view";
import { SpinnerView } from "@showtime-xyz/universal.spinner";
export const RefreshControl = ({ progress, refreshType, }) => {
    ...
    useAnimatedReaction(() => refreshType.value, (type) => {
        if (type === RefreshTypeEnum.Refreshing && !isRefreshed.value) {
            containerAnimationValue.value = withRepeat(withTiming(360, { duration: 400, easing: Easing.linear }), -1, false);
    ...
    return (<Animated.View style={[styles.container, containerAnimatedStyle]}>
